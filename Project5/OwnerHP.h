...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(183, 95);
			...
			this->label1->Location = System::Drawing::Point(86, 102);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(183, 137);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(183, 180);
			...
			this->label4->Location = System::Drawing::Point(86, 187);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(183, 222);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(685, 378);
			...
			this->label6->Location = System::Drawing::Point(205, 352);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(111, 13);
			this->label6->TabIndex = 27;
			this->label6->Text = L"All details Except P ID";
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(380, 352);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(67, 13);
			this->label7->TabIndex = 28;
			this->label7->Text = L"Only P name";
			// 
			// OwnerHP
			// 
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		SqlCommand^ cmdDataBase1 = gcnew SqlCommand("UPDATE dbo.Products SET  quantity ='" + this->textBox4->Text + "' WHERE pname ='" + this->textBox2->Text + "';",sqlConn1);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	SqlCommand^ cmdDataBase2 = gcnew SqlCommand("DELETE from dbo.Products  WHERE pname ='" + this->textBox2->Text + "';", sqlConn2);
